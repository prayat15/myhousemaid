...
import 'package:housemaid/payment.dart';
import 'package:housemaid/registrationscreen.dart';
import 'package:housemaid/splashscreen.dart';
import 'package:housemaid/user.dart';
...
String urlgetuser = "http://maccik15.com/myhousemaid/php/get_user.php";
String urluploadImage =
    "http://maccik15.com/myhousemaid/php/upload_imageprofile.php";
String urlupdate = "http://maccik15.com/myhousemaid/php/update_profile.php";
File _image;
int number = 0;
String _value;
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                "http://maccik15.com/myhousemaid/profile/${widget.user.email}.jpg?dummy=${(number)}'")))),
                              ),
                              SizedBox(height: 5),
                              Container(
                                child: Text(
