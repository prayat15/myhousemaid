...
import 'package:housemaid/newjob.dart';
...
class _TabScreen2State extends State<TabScreen2> {
                              ...
                              children: <Widget>[
                                 Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    fit: BoxFit.fill,
                                    image: NetworkImage(
                                    "http://maccik15.com/myhousemaid/images/${data[index]['jobimage']}.jpg"
                                  )))),
                                Expanded(
                                  child: Container(
                                    child: Column(
  ...
  Future<String> makeRequest() async {
    String urlLoadJobs = "http://maccik15.com/myhousemaid/php/load_job_user.php";
  ...
  Future<String> deleteRequest(String jobid) async {
    String urlLoadJobs = "http://maccik15.com/myhousemaid/php/delete_job.php";
    ProgressDialog pr = new ProgressDialog(context,
        type: ProgressDialogType.Normal, isDismissible: false);
